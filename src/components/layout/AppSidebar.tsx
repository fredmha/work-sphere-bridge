...
/**
 * AppSidebar renders the sidebar content as part of the layout flow
 * (no fixed positioning), sitting directly under the global header.
 * Added a max-width to prevent over-expansion.
 */
export function AppSidebar() {
  ...
  const getNavClasses = (path: string) => {
    const base = 'flex items-center gap-3 rounded-lg px-3 py-2 text-sm transition-all hover:bg-accent/50';
  ...
  return (
    <SidebarContent className="w-full max-w-xs bg-gradient-to-b from-background to-background/80 backdrop-blur-xl border-r border-border/50 relative">
      {/* Logo / Brand */}
