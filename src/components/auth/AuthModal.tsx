...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, defaultTab = 'login' }) => {
  ...
  const [signupData, setSignupData] = useState({
    ...
    userType: 'contractor' as 'contractor', // This maps to 'role' in users table
  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => { setSignupStep(1); setShowManualSignup(false); onClose(); }}>
      <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <Tabs value="signup" onValueChange={(value) => { setActiveTab(value as 'signup'); setSignupStep(1); setShowManualSignup(false); }}>
